...
export function AuthSocialProviders({ enabledProviders, setIsLoading, isLoading, lastMethod }: AuthSocialProvidersProps) {
  ...
  if (!(enabledProviders.google || enabledProviders.github)) {
    return null;
  }
